...
vamos a hacerlo en eclipse, lo primero es clonar la rama feature/database-goose-new, una vez clonada creamos un nuevo paquete llamado utilerias y dentro una nueva clase llamada digestión en la cual escribimos el siguiente código que nos va a generar el Md5 y lo va a convertir a hexadecimal.
...
```
En la clase ProductoController añadimos las siguientes líneas de código
```java
